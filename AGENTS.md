...
- **Bar 1 — partially cleared.** B1.1, B1.2, B1.4, B1.6 met. B1.3 partial (4 of 6 preferred examples; sovereign wealth and dark-fleet deferred with reason). B1.5 deferred (no validation script).
