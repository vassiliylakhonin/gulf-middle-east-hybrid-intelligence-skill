...
Lightweight, honest review materials for memos produced with the Gulf + Middle East skill. **Not a benchmark.**

- [`checklist.md`](checklist.md) — yes/no human review checklist
- [`failure-modes.md`](failure-modes.md) — common failure patterns with diagnostic cues
- [`starter-rubric.md`](starter-rubric.md) — starter scoring rubric (informational, not certifying)
