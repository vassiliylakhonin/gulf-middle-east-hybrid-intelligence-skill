...
8. Read [source-conflict-iran-crude-export-trackers.md](source-conflict-iran-crude-export-trackers.md) to see the **source-conflict-surfacing rule** applied to a sanctions-adjacent estimation problem: four credible sources (US official + three commercial trackers) disagree on Iranian crude export volume; the memo names all four with provenance, rigorously assesses source independence (trackers are NOT independent — overlapping AIS / satellite / port-call inputs), states a preferred position with regret-asymmetry reasoning rather than picking a side, and carries the conflict through to a dual-calibration compliance posture instead of silently averaging.
...
| [live-source-backed-bab-el-mandeb-red-sea-shipping.md](live-source-backed-bab-el-mandeb-red-sea-shipping.md) | `live-source-backed` | Bab-el-Mandeb / Red Sea shipping disruption — pricing and routing exposure for a shipping insurer or industrial charterer. CMF/IMO retrieved 2026-05-15; LMA JWC and IEA OMR refreshed 2026-07-11; UKMTO remains `[verify]`. |
...
| [source-conflict-iran-crude-export-trackers.md](source-conflict-iran-crude-export-trackers.md) | `illustrative source packet` | Source-conflict-surfacing demonstrator — Iranian crude export volume disagreement across US official statements and three commercial trackers (Kpler / Vortexa / TankerTrackers-style); rigorous source-independence assessment; regret-asymmetry calibration for compliance posture. |
