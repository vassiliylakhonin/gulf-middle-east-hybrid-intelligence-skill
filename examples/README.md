...
- **GCC correspondent banking exposure for a Western respondent bank** — deferred. Will land alongside a `live-source-backed` example with current BIS consolidated banking statistics, OFAC actions, and central-bank announcements.
...
Source-freshness discipline updates to [`docs/source-guide.md`](../docs/source-guide.md) are the next priority for B2.6.
